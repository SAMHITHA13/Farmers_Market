                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" name="hobbies" id="inlineCheckboxh1" value="Organic Farming" onChange={this.handleCheckboxChange} />
                                            <label class="form-check-label" for="inlineCheckboxh1">Organic Farming</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" name="hobbies" id="inlineCheckboxh2" value="Kharif crops" onChange={this.handleCheckboxChange} />
                                            <label class="form-check-label" for="inlineCheckboxh2">Kharif crops</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" name="hobbies" id="inlineCheckboxh3" value="Rabi Crops" onChange={this.handleCheckboxChange} />
                                            <label class="form-check-label" for="inlineCheckboxh3">Rabi Crops</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" name="hobbies" id="inlineCheckboxh4" value="Organic Fertilizers" onChange={this.handleCheckboxChange} />
                                            <label class="form-check-label" for="inlineCheckboxh4">Organic Fertilizers</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" name="hobbies" id="inlineCheckboxh5" value="horticulture" onChange={this.handleCheckboxChange} />
                                            <label class="form-check-label" for="inlineCheckboxh5">horticulture</label>
                                        </div>
                                    </div>
                                </div>
                                <div className="form-group">
